...
const char* ssid = "Mr. WiFi";  // Enter SSID here
...
String SendHTML(uint8_t ledstat){
  ...
  ptr +="body{margin-top: 50px;} h1 {color: #222222;margin: 50px auto 30px;} h3 {color: #222222;margin-bottom: 50px;}\n";
  ...
  ptr +="<h3>BUILTIN LED Controller</h3>\n";
   ...
   if(ledstat)
  {ptr +="<a class=\"button button-off\" href=\"/ledoff\">OFF</a>\n";}
  else
  {ptr +="<a class=\"button button-on\" href=\"/ledon\">ON</a>\n";}
